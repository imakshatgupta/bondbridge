        ...
        <div className="col-span-2 border-r border-border  text-xl flex flex-col">
            ...
            <div className=" p-4 w-fit mx-auto flex flex-col justify-between h-full">
                <ul className="space-y-4">
                    <li>
                        <Link to="/" className="flex items-center space-x-3 text-sidebar-foreground font-medium">
                    ...
                    <li>
                        <Link to="/search" className="flex items-center space-x-3 text-gray-600">
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <Link to="/activity" className="flex items-center space-x-3 text-gray-600">
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <Link to="/notifications" className="flex items-center space-x-3 text-gray-600">
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <Link to="/chat" className="flex items-center space-x-3 text-sidebar-primary">
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {showSidebars ? (
                <div className="grid lg:grid-cols-12 w-full ">
                    ...
                    <div className='flex col-span-10'>
                        ...
                        {/* Right Sidebar */}
                        {activeChat ? <>
                            <div className="h-[calc(100vh-64px)] w-2/3">
                                <ChatInterface
