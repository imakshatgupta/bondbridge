        ...
        <div className="col-span-2 border-r border-border  text-xl flex flex-col h-[calc(100vh-64px)]">
            ...
            <div className=" p-4 w-fit mx-auto flex flex-col justify-between h-full">
                <ul className="space-y-6 text-muted-foreground">
                    <li>
                        <Link to="/" className={`flex items-center space-x-3 ${pathname === '/' ? 'font-medium text-foreground' : ''}`}>
                    ...
                    <li>
                        <Link to="/search" className={`flex items-center space-x-3 ${pathname === '/search' ? 'font-medium text-foreground' : ''}`}>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <Link to="/activity" className={`flex items-center space-x-3 ${pathname === '/activity' ? 'font-medium text-foreground' : ''}`}>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <Link to="/notifications" className={`flex items-center space-x-3 ${pathname === '/notifications' ? 'font-medium text-foreground' : ''}`}>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <Link to="/bondchat" className={`flex items-center space-x-3 ${pathname === '/bondchat' ? 'font-medium' : ''}`}>
                ...
                {/* Settings */}
                <div className="pb-5">
                    <Link to="/settings" className={`flex items-center space-x-3 ${pathname === '/settings' ? 'font-medium text-foreground' : ''}`}>
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {showSidebars ? (
                <div className="grid lg:grid-cols-12 w-full">
                    ...
                    <div className='flex col-span-10'>
                        ...
                        {/* Main Content */}
                        <div className={`border-r w-full border-border p-10 overflow-y-auto app-scrollbar bg-background h-[calc(100vh-64px)] ${className}`}>
                            {children}
                        </div>
