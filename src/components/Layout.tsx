        ...
        <div className="col-span-2 border-r border-border  text-xl flex flex-col h-[calc(100vh-64px)]">
            ...
            <div className=" p-4 w-fit mx-auto flex flex-col justify-between h-full">
                <ul className="space-y-6 text-muted-foreground">
                    <li>
                        <a href="/" className={`flex items-center space-x-3 ${pathname === '/' ? 'font-medium text-foreground' : ''}`}>
                    ...
                    <li>
                        <a href="/search" className={`flex items-center space-x-3 ${pathname === '/search' ? 'font-medium text-foreground' : ''}`}>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="/activity" className={`flex items-center space-x-3 ${pathname === '/activity' ? 'font-medium text-foreground' : ''}`}>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="/notifications" className={`flex items-center space-x-3 ${pathname === '/notifications' ? 'font-medium text-foreground' : ''}`}>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* Settings */}
                <div className="pb-5">
                    <a href="/settings" className={`flex items-center space-x-3 ${pathname === '/settings' ? 'font-medium text-foreground' : ''}`}>
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
