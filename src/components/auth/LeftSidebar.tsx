            ...
            <div className=" p-4 w-fit mx-auto flex flex-col justify-between h-full">
                <ul className="space-y-6 text-muted-foreground">
                    <li>
                        <Link
                            to="/"
                            className={`flex items-center space-x-3 ${pathname === "/" ? "font-medium text-foreground" : ""
                                }`}
                        >
                    ...
                    <li>
                        <Link
                            to="/search"
                            className={`flex items-center space-x-3 ${pathname === "/search" ? "font-medium text-foreground" : ""
                                }`}
                        >
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <Link
                            to="/activity"
                            className={`flex items-center space-x-3 ${pathname === "/activity" ? "font-medium text-foreground" : ""
                                }`}
                        >
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <Link
                            to="/notifications"
                            className={`flex items-center space-x-3 ${pathname === "/notifications"
                    ...
                    <li>
                        <Link
                            to="/bondchat"
                            className={`flex items-center space-x-3 ${pathname === "/bondchat" ? "font-medium" : ""
                                }`}
                        >
                ...
                <div className="pb-5">
                    <Link
                        to="/settings"
                        className={`flex items-center space-x-3 ${pathname === "/settings" ? "font-medium text-foreground" : ""
                            }`}
                    >
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
