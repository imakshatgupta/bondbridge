...
//         try {
//             const { data } = await axios.post('http://localhost:3000/api/login', { phoneNumber, password });
//             if(data.status == 200){
//                 // Send OTP after successful phoneNumber/password verification
//                 await axios.post('http://localhost:3000/api/send-otp', { phoneNumber });
...
//         try {
//             await axios.post('http://localhost:3000/api/verify-otp', { phoneNumber, otp });
